...
class Sites:
    ...
    def init_config(self):
        ...
        for site in self._sites:
            ...
            if site_uses:
                ...
                login_enable = True if "L" in site_uses and site_signurl and site_cookie else False
                ...
                uses.append("L") if login_enable else None
    ...
    def get_sites(self,
        ...
        for site in self._siteByIds.values():
            ...
            if signin and not site.get('signin_enable'):
                continue
            if login and not site.get('login_enable'):
                continue
    ...
    def test_connection(self, site_id):
        ...
        if site_info.get("chrome") and chrome.get_status():
            ...
            if not cloudflare:
                return False, "跳转站点失败", elapsed_ms
            # 判断是否已签到
            ...
            if SiteHelper.is_logged_in(html_text):
                ...
                return False, "Cookie失效", elapsed_ms
        else:
            # 计时
            start_time = datetime.now()
            ...
            if res and res.status_code == 200:
                ...
                return False, f"连接失败，状态码：{res.status_code}", elapsed_ms
            else:
                return False, "无法打开网站", elapsed_ms
