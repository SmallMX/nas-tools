        ...
        try:
            ...
            if ipaddr.version == 4:
                ...
                for allow_ipv4 in allow_ipv4s:
                    if ipaddr in ipaddress.ip_network(allow_ipv4.strip(), strict=False):
                        return True
                ...
                allow_ipv4s = allow_ips.get('ipv4').split(",")
                for allow_ipv4 in allow_ipv4s:
                    if ipaddr.ipv4_mapped in ipaddress.ip_network(allow_ipv4.strip(), strict=False):
                        return True
            else:
                ...
                for allow_ipv6 in allow_ipv6s:
                    if ipaddr in ipaddress.ip_network(allow_ipv6.strip(), strict=False):
                        return True
